        ...
        <div class="col-xl-12 col-lg-8">
            <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex">
                            ...
                            <input type="text" class="form-control w-50 ms-3"
                                id="exampleFormControlInput7" placeholder="USA">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput3" class="form-label text-primary">Email<span
                                class="required">*</span></label>
                ...
                <div class="col-xl-6 col-sm-6">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput5" class="form-label text-primary">Parent
                            Name<span class="required">*</span></label>

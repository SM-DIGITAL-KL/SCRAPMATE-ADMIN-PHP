...
<!-- Mirrored from akademi.dexignlab.com/cakephp/demo/akademi-admin/index2 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 May 2024 09:13:12 GMT -->
<!-- Added by HTTrack -->
<meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<title>SCRAPMATE</title>
...
<!-- Meta -->
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/fontawesome-fix.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/wow-master/css/libs/animate.css') }}/">
    <link rel="stylesheet" href="{{ asset('assets/vendor/bootstrap-select-country/css/bootstrap-select-country.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/datepicker/css/bootstrap-datepicker.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/clockpicker/css/bootstrap-clockpicker.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/jquery-asColorPicker/css/asColorPicker.min.css') }}">

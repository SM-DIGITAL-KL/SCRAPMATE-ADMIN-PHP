...
<div id="main-wrapper" class="  active">
    ...
    <a href="#" class="brand-logo">
        <img src="{{ asset('assets/images/scrap.png') }}" width="55" height="55" viewBox="0 0 58 60" fill="none">
        {{-- <svg class="logo-abbr" width="40" height="40" viewBox="0 0 48 54" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <rect y="3" width="48" height="48" rx="16" fill="#FB7D5B" />
            <path d="M28.964 35.536H19.532L18.02 40H11.576L20.72 14.728H27.848L36.992 40H30.476L28.964 35.536ZM27.38 30.784L24.248 21.532L21.152 30.784H27.38Z"
                fill="white" />
        </svg> --}}
        <div class="brand-title">
            <svg width="140" height="30" viewBox="0 0 140 30" xmlns="http://www.w3.org/2000/svg">
                <rect width="140" height="30" fill="none"/>
                <text x="10" y="25" font-family="Arial" font-size="20" fill="white" font-weight="bold">{{ $adminProfile['name'] ?? ($adminProfile->name ?? 'SCRAP') }}</text>
              </svg>
                            ...
                            <div class="dropdown-menu dropdown-menu-end pb-0" style="">
                                <div class="card mb-0">
                                    ...
                                    <div class="card-body p-3">
                                         <a href="{{ route('manage_site') }}" class="dropdown-item ai-icon ">
                                        ...
                                        <a href="{{ route('report') }}" class="dropdown-item ai-icon ">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24" />

...
<div class="footer footer-outer">
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script>
    	var csrfToken = '3yQW9E8vX9aPBNo+79iemGn3xaDWz/NHllVgTEvcTbcgodS1VhIWc8VJ97KlR1O3u1Uye8ZVN9kuXkkKwf7CM+0H3fMUb+CCW5GhmOL3knGuZ1F8f+h7gBHD7IBgJCdGpiiW1JZ0Zo/eZFBL9WNV6g=='; 
    </script>
			<script>var asset_base_url = '/cakephp/demo/';</script>
			<script>
				const BASE_URL = 'https://akademi.dexignlab.com/cakephp/demo' ;
			</script>
    ...
    <!-- Page level css : Dashboard 2 -->
        ...
        {{-- style.css 13084 and 13664 hided 2 panels --}}

</body>

<!-- Mirrored from akademi.dexignlab.com/cakephp/demo/akademi-admin/index2 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 May 2024 09:13:21 GMT -->
</html>

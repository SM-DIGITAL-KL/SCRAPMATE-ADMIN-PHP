            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">SR Users List (Shop + Recycler)</h4>
                        <hr>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-hover" id="srUsersTable" style="margin-bottom: 0;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            // For SR users, use the calculated approval_status from backend
                                                            // which shows "approved" only when both B2B and B2C are approved
                                                            if ($appVersion === 'v2') {
                                                                // Use the calculated approval_status from backend (already handles B2B+B2C logic)
                                                    ...
                                                    <td>
                                                        <a href="{{ route('srUserDocuments', ['userId' => $user->id]) }}" class="btn btn-sm btn-info" title="View Details">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
...
<style>
    ...
    #srUsersTable td:nth-child(2) {
        padding-right: 30px !important;
    }
    #srUsersTable td:nth-child(3) {
        padding-left: 20px !important;
    }
    #srUsersTable td:nth-child(5) {
...
function loadSRUsers(page, limit, search) {
    // Show loading indicator
    const tbody = document.querySelector('#srUsersTable tbody');
    ...
    // Build URL
    let url = "{{ route('srUsers') }}?page=" + page + "&limit=" + limit;
    ...
    .then(html => {
        ...
        // Extract table body
        const newTbody = tempDiv.querySelector('#srUsersTable tbody');
...
function attachPaginationListeners() {
    ...
    document.querySelectorAll('.pagination a.pagination-link').forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            loadSRUsers(page, currentLimit, currentSearch);
        });
    });
}
...
function changeEntriesPerPage() {
    ...
    loadSRUsers(1, parseInt(limit), currentSearch);
}

function performSearch() {
    const search = document.getElementById('searchInput').value;
    loadSRUsers(1, currentLimit, search);
}

function clearSearch() {
    document.getElementById('searchInput').value = '';
    loadSRUsers(1, currentLimit, '');
}

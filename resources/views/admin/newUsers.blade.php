            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">New Users List</h4>
                        <hr>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-hover" id="newUsersTable" style="margin-bottom: 0;">
...
<style>
    ...
    #newUsersTable td:nth-child(2) {
        padding-right: 30px !important;
    }
    #newUsersTable td:nth-child(3) {
        padding-left: 20px !important;
    }
    #newUsersTable td:nth-child(5) {
...
function loadNewUsers(page, limit, search, appVersion) {
    // Show loading indicator
    const tbody = document.querySelector('#newUsersTable tbody');
    tbody.innerHTML = '<tr><td colspan="7" class="text-center"><div class="spinner-border" role="status"><span class="visually-hidden">Loading...</span></div></td></tr>';
    
    // Build URL
    let url = "{{ route('newUsers') }}?page=" + page + "&limit=" + limit;
    ...
    .then(html => {
        ...
        // Extract table body
        const newTbody = tempDiv.querySelector('#newUsersTable tbody');
...
function attachPaginationListeners() {
    ...
    document.querySelectorAll('.pagination a.pagination-link').forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            loadNewUsers(page, currentLimit, currentSearch, currentAppVersion);
        });
    });
}
...
function changeEntriesPerPage() {
    ...
    loadNewUsers(1, parseInt(limit), currentSearch, currentAppVersion);
}

function performSearch() {
    const search = document.getElementById('searchInput').value;
    loadNewUsers(1, currentLimit, search, currentAppVersion);
}

function clearSearch() {
    document.getElementById('searchInput').value = '';
    loadNewUsers(1, currentLimit, '', currentAppVersion);
}

function filterByVersion(version) {
    currentAppVersion = version || '';
    loadNewUsers(1, currentLimit, currentSearch, currentAppVersion);
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    updateFilterButtons(currentAppVersion);
